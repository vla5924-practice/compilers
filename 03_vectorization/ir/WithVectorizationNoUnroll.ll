...
vector.body:                                      ; preds = %entry, %vector.body
  ...
  %wide.load24 = load <4 x float>, <4 x float>* %6, align 4, !tbaa !7, !alias.scope !12
  %7 = fadd <4 x float> %wide.load, %wide.load24
  %8 = getelementptr inbounds float, float* %2, i64 %index
  %9 = bitcast float* %8 to <4 x float>*
  store <4 x float> %7, <4 x float>* %9, align 4, !tbaa !7, !alias.scope !14, !noalias !16
  %index.next = add i64 %index, 4
  %10 = icmp eq i64 %index.next, 1048576
  br i1 %10, label %for.cond.cleanup, label %vector.body, !llvm.loop !17
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %11 = load float, float* %add.ptr.i, align 4, !tbaa !7
  %add.ptr.i14 = getelementptr inbounds float, float* %1, i64 %indvars.iv
  %12 = load float, float* %add.ptr.i14, align 4, !tbaa !7
