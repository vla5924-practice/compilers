...
for.body:                                         ; preds = %for.body, %entry
  ...
  %5 = load float, float* %add.ptr.i.1, align 4, !tbaa !7
  %add.ptr.i14.1 = getelementptr inbounds float, float* %1, i64 %indvars.iv.next
  %6 = load float, float* %add.ptr.i14.1, align 4, !tbaa !7
  ...
  %7 = load float, float* %add.ptr.i.2, align 4, !tbaa !7
  %add.ptr.i14.2 = getelementptr inbounds float, float* %1, i64 %indvars.iv.next.1
  %8 = load float, float* %add.ptr.i14.2, align 4, !tbaa !7
  ...
  %9 = load float, float* %add.ptr.i.3, align 4, !tbaa !7
  %add.ptr.i14.3 = getelementptr inbounds float, float* %1, i64 %indvars.iv.next.2
  %10 = load float, float* %add.ptr.i14.3, align 4, !tbaa !7
