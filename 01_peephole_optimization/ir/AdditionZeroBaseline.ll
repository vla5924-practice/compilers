; ModuleID = 'cpp/AdditionZeroSample.cpp'
...
for.body:                                         ; preds = %for.cond
  ...
  %add = add i64 %2, 0
  store i64 %add, i64* %sum_0, align 8
  %3 = load i64, i64* %sum_1, align 8
  %add2 = add i64 %3, 0
  store i64 %add2, i64* %sum_1, align 8
  %4 = load i64, i64* %sum_2, align 8
  %add3 = add i64 %4, 0
  store i64 %add3, i64* %sum_2, align 8
  %5 = load i64, i64* %sum_3, align 8
  %add4 = add i64 %5, 0
  store i64 %add4, i64* %sum_3, align 8
  %6 = load i64, i64* %sum_4, align 8
  %add5 = add i64 %6, 0
  store i64 %add5, i64* %sum_4, align 8
  %7 = load i64, i64* %sum_5, align 8
  %add6 = add i64 %7, 0
  store i64 %add6, i64* %sum_5, align 8
  %8 = load i64, i64* %sum_6, align 8
  %add7 = add i64 %8, 0
  store i64 %add7, i64* %sum_6, align 8
  %9 = load i64, i64* %sum_7, align 8
  %add8 = add i64 %9, 0
  store i64 %add8, i64* %sum_7, align 8
  %10 = load i64, i64* %sum_8, align 8
  %add9 = add i64 %10, 0
  store i64 %add9, i64* %sum_8, align 8
  %11 = load i64, i64* %sum_9, align 8
  %add10 = add i64 %11, 0
  store i64 %add10, i64* %sum_9, align 8
